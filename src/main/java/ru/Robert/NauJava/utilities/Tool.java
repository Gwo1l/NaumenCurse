...
public class Tool {
    public static Country createCountryAndSave(String countryName, String code, CountryRepository cr) {
    ...
    public static Note createNoteAndSave(LocalDateTime creationDate, String text, NoteRepository nr) {
